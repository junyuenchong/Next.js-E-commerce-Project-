...
/** Wait until the singleton client is ready (same idea as rate-limit / admin-events). */
...
/** Delete keys matching a Redis glob (e.g. `products:list:*`). Uses SCAN — safe for production. */
...
/** Server-side key builders for product/category cache (Redis). */
