...
import StorefrontVoucherStrip from "@/app/modules/user/client/components/coupons/StorefrontVoucherStrip";
import type { SavedAddress } from "@/app/modules/user/client/components/profile/AddressBookSection";
      ...
      <div className="max-w-lg mx-auto space-y-6">
        ...
        <div className="rounded-lg border border-gray-200 bg-gray-50 p-4">
          ...
          <p className="mt-1 text-xs text-gray-600">
            For codes from email or social that are not shown as vouchers above.
          </p>
          {promoLocalErr ? (
            <p className="mt-2 text-xs text-red-700">{promoLocalErr}</p>
          ) : null}
        ...
        <div className="bg-white rounded-lg shadow-sm p-5 space-y-3">
          ...
          <p className="text-xs text-gray-500">
            Email receipt is sent automatically when you are signed in (session
            email).
          </p>
        </div>
          ...
          <div className="rounded-2xl border border-emerald-200 bg-white p-6 shadow-sm">
            <div className="flex flex-col items-center text-center">
              ...
              <div className="mt-5 w-full grid gap-2 sm:grid-cols-2">
                {paidOrderId ? (
                  <Link
                    href={`/modules/user/orders/${paidOrderId}`}
