...
import { useAdminProductReviews } from "@/app/modules/admin/hooks";
...
const ProductItem = memo(function ProductItem({
  ...
  const salePriceDisplay = moneyToNumber(product.price);
  const listPriceDisplay = moneyToNumber(product.compareAtPrice);
        ...
        <div className="flex flex-col h-full">
          ...
          <div className="flex-1 space-y-2">
            ...
            <div className="flex items-center justify-between gap-2 flex-wrap">
              <div className="text-lg font-bold text-green-600 flex flex-wrap items-baseline gap-2">
                ${salePriceDisplay.toFixed(2)}
                {listPriceDisplay > salePriceDisplay ? (
                  <span className="text-sm text-gray-400 line-through font-normal">
                    ${listPriceDisplay.toFixed(2)}
                  </span>
                ) : null}
              </div>
